export const projects = [
  {
    title: "Spot",
    description:
      "A fun and interactive housing marketplace created by university students, intended to match tenants with landlords. Swipe to rent and get matched with a dynamic ELO system.",
    image: "test.png",
  ...
  },
  {
    title: "Chemistry 11",
    description:
      "A handy and comprehensive study resource for students taking 11th grade chemistry. Includes search, visualization, and filtering tools for better experience.",
    image: "c11.png",
